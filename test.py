...
extraodinary_testcase_Property_3 = Property(5, 655e5, 15, True)
extraordinary_testcase_Person_3 = Person("Carlos Sanchez", 60, False, True, extraodinary_testcase_Property_3, True)
...
class inverse_mortage(unittest.TestCase):
    ...
    def test_extraordinary_2(self):
        self.assertTrue(extraordinary_testcase_Person_2.is_old_enough())
        self.assertTrue(extraordinary_testcase_Property_2.required_stratum())
        self.assertTrue(extraordinary_testcase_Property_2.is_value_enough())
    ...
    def test_extraordinary_3(self):
        self.assertEqual(extraordinary_testcase_Person_3.is_old_enough(), False)
        self.assertTrue(extraodinary_testcase_Property_3.required_stratum())
        self.assertTrue(extraodinary_testcase_Property_3.is_value_enough())
        self.assertTrue(extraodinary_testcase_Property_3.is_property_valid())
    ...
    def test_fail_1(self):
        ...
        self.assertTrue(fail_testcase_Property_1.is_value_enough())
    ...
    def test_fail_2(self):
        ...
        self.assertTrue(fail_testcase_Property_2.required_stratum())
        self.assertTrue(fail_testcase_Property_2.is_value_enough())
    ...
    def test_fail_3(self):
        ...
        self.assertEqual(fail_testcase_Property_3.is_value_enough(), False)
